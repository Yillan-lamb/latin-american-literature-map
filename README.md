...
- **当前 Web Development**：`Web 0.5.0 Development`，WCD-09 已将活动地图升级为可重建的 Natural Earth 50m 底图、LAEA 等积投影与 L1 背景 / L2 文学交互分层，并增加范围、来源和争议边界中立性说明；Research layer 保持 377 entities / 1027 facts / 334 relationships / 314 sources / 261 content cards；WCD-08 经 USER 批准的 95 条趣闻中，82 条投影到 24 位现有公开作者页，13 条因作者不在公开范围而不投影；主页以地图、阅读路径与趣闻精选为主，完整作家、作品与趣闻目录从顶部独立入口进入；
...
project/    项目治理、长期规范、计划、正式审计和 AI 协作文档
```
