...
The historical `data/v2/release/V2.0.0_RELEASE_MANIFEST.json` remains unchanged because it is explicitly a superseded historical release candidate. This WCD manifest is the live scope/count record for the development patch and does not reopen the Public Release gate.
