...
('SRC-0282','WCD03-SRC-02','短暂的一生','La vida breve','','','麥田出版','2021','','catalog_record','','zh','D','access_pass','WCD-03','Published Chinese-title support for 《短暂的一生》','remote_only','','https://www.sanmin.com.tw/product/index/009355218'),
...
('SRC-0284','WCD03-SRC-04','毁灭者亚巴顿','Abaddón el exterminador','','','四川文艺出版社','2021','','catalog_record','','zh','D','access_pass','WCD-03','Published Chinese-title support for 《毁灭者亚巴顿》','remote_only','','https://book.douban.com/subject/35430544/'),
('SRC-0285','WCD03-SRC-05','营救距离','Distancia de rescate','','','人民文学出版社','2018','9787020134663','catalog_record','','zh','D','access_pass','WCD-03','Published Chinese-name support for 萨曼塔·施维伯林 and 《营救距离》','remote_only','','https://book.douban.com/subject/27176200/'),
...
UPDATE entities SET name_zh='《短暂的一生》', normalization_basis='Published Chinese title supported by a Chinese-language bookseller catalogue; original title and entity identity retained.' WHERE entity_id='V1-ENT-0187';
...
UPDATE content_cards SET
  title_zh=CASE subject_id
    WHEN 'V1-ENT-0172' THEN '若热·亚马多' WHEN 'V1-ENT-0187' THEN '《短暂的一生》'
  ...
  content_markdown=REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(content_markdown,
    '豪尔赫·亚马多','若热·亚马多'),'《短暂的生命》','《短暂的一生》'),'《夜晚的淫鸟》','《污秽的夜鸟》'),'《阿巴顿，毁灭者》','《毁灭者亚巴顿》'),'萨曼塔·施韦布林','萨曼塔·施维伯林'),'《救援距离》','《营救距离》'),'《口中之鸟》','《吃鸟的女孩》'),'《我们在火中失去的东西》','《火中遗物》'),'《我们的夜晚》','《属于我们的夜晚》'),'《床上吸烟的危险》','《床上抽烟危险》'),'《树木的私生活》','《树的隐秘生活》'),'《回家的方式》','《回家的路》');

UPDATE relationships SET description_zh=REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(description_zh,
  '豪尔赫·亚马多','若热·亚马多'),'《短暂的生命》','《短暂的一生》'),'《夜晚的淫鸟》','《污秽的夜鸟》'),'《阿巴顿，毁灭者》','《毁灭者亚巴顿》'),'萨曼塔·施韦布林','萨曼塔·施维伯林'),'《救援距离》','《营救距离》'),'《口中之鸟》','《吃鸟的女孩》'),'《我们在火中失去的东西》','《火中遗物》'),'《我们的夜晚》','《属于我们的夜晚》'),'《床上吸烟的危险》','《床上抽烟危险》'),'《树木的私生活》','《树的隐秘生活》'),'《回家的方式》','《回家的路》');
UPDATE relation_holds SET description_zh=REPLACE(description_zh,'《短暂的生命》','《短暂的一生》');
UPDATE relation_hold_evidence SET evidence_note=REPLACE(evidence_note,'《短暂的生命》','《短暂的一生》');
...
('V1-CS-0507','WCD-03','V1-CARD-0077','SRC-0282','D','display','yes','no','SRC-0282','used','NONE'),
('V1-CS-0508','WCD-03','V1-CARD-0081','SRC-0283','B','display','yes','no','SRC-0283','used','NONE'),
('V1-CS-0509','WCD-03','V1-CARD-0087','SRC-0284','D','display','yes','no','SRC-0284','used','NONE'),
('V1-CS-0510','WCD-03','V1-CARD-0184','SRC-0285','D','display','yes','no','SRC-0285','used','NONE'),
('V1-CS-0511','WCD-03','V1-CARD-0184','SRC-0286','B','display','yes','no','SRC-0286','used','NONE'),
('V1-CS-0512','WCD-03','V1-CARD-0187','SRC-0285','D','display','yes','no','SRC-0285','used','NONE'),
