...
审计覆盖：`PROJECT_CHARTER.md`、`V2_TASKS.md`、V2 执行体系、产品总说明书、项目决策记录、`data/master/V1_MASTER.sqlite`、`data/v2/geo/`、`data/v2/curation/`、`data/v2/web/`、`scripts/build_v2_*.py`、`scripts/validate_v2_web_data.py`、`site/`、`.github/workflows/v2-pages.yml`、V2 QA 和发布候选材料。
...
- `V2_TASKS.md` 同时保留 N3 和 N4 的动态状态表述；
- `V2_执行体系与任务清单.md` 仍引用不存在的 `V2_N3_TEST_SITE_REVIEW.md` 与 `V2_RELEASE_QA.md`，并写下一节点为 N2；
