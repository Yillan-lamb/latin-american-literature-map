...
module.exports = defineConfig({
  ...
  outputDir: "artifacts/v2-rc5/browser/failures",
  reporter: [["json", { outputFile: "artifacts/v2-rc5/browser/playwright-results.json" }], ["html", { outputFolder: "artifacts/v2-rc5/browser/html", open: "never" }]],
  use: {
