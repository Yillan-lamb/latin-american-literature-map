...
| 阶段 0 | `project/tasks/V2_TASKS.md`、Charter 1.5.0、DEC-040 | 已完成 |
...
- `project/tasks/V2_TASKS.md`：动态状态与节点状态；
- `project/decisions/拉丁美洲文学地图_项目决策记录.md`：DEC-040 至 DEC-044；
- `project/audits/archive/V2_N2_PROTOTYPE_REVIEW.md`：N2 审核包；
- `project/audits/web/V2_N3_FULL_TEST_SITE_REVIEW.md`：N3 审核包；
- `docs/releases/V2_RELEASE_NOTES.md`：当前发布候选说明。
...
1. `project/governance/PROJECT_CHARTER.md`：项目总章程，V2 的版权、来源、数据、AI 和发布边界以上位规则为准；
2. `project/plans/V2_网站产品决策与开发总说明书.md`：V2 最高专项说明书，状态为 `FROZEN / USER APPROVED`；
3. `project/plans/V2_执行体系与任务清单.md`：V2 文件层级、节点和任务管理规则；
4. `project/tasks/V2_TASKS.md`：V2 唯一动态状态源；
5. `project/decisions/拉丁美洲文学地图_项目决策记录.md`：V2 决策链 DEC-040—DEC-044；
...
- `docs/releases/V1_版本摘要.md`、`docs/releases/V1_正式发布说明.md`、`docs/releases/V1_已知问题.md`：V1 正式基线、已知问题和发布边界。
...
- `docs/web/V2_TECHNICAL_FOUNDATION.md`
...
- `project/audits/archive/V2_N2_MINIMAL_CURATION_QA.md`
- `project/audits/archive/V2_N2_PROTOTYPE_REVIEW.md`
- `project/audits/archive/V2_HOME_MAP_PROTOTYPE.md`
- `project/audits/archive/V2_PAGE_TEMPLATES.md`
- `project/audits/archive/V2_SEARCH_TIMELINE.md`

### 3.5 阶段 5：全量数据和策展

- `project/plans/V2_FULL_PAGE_COVERAGE.md`
- `data/v2/qa/V2_PAGE_COVERAGE.csv`
- `scripts/build_v2_coverage_plan.py`
- `project/audits/web/V2_FULL_CURATION_DRAFTS_QA.md`
- `data/v2/qa/V2_CURATION_BATCH_BUILD.json`
- `scripts/build_v2_full_curation_drafts.py`
- `project/audits/web/V2_CURATION_USER_REVIEW.md`
...
- `project/audits/web/V2_HOME_FULL.md`
- `project/audits/web/V2_MAP_FULL.md`
- `project/audits/web/V2_PAGES_FULL_QA.md`
- `project/audits/web/V2_SEARCH_FULL_QA.md`
- `project/audits/web/V2_TIMELINE_FULL_QA.md`
- `project/audits/web/V2_RESEARCH_EVIDENCE_QA.md`
- `project/audits/web/V2_RESPONSIVE_A11Y_QA.md`
...
- `project/audits/web/V2_PUBLIC_BOUNDARY_QA.md`
- `project/audits/web/V2_DEPLOYMENT_PREP.md`
- `docs/releases/V2_RELEASE_NOTES.md`
