...
- **当前 Web 版本**：`Web 0.2.1 — DEVELOPMENT`
- **当前产品状态**：`DEVELOPMENT`
- **Public Release**：`PAUSED BY USER`
- **当前任务**：WCD-01 Global Curation Triage 已完成
- **下一任务**：WCD-02 Literary Space & Relationship Deepening
...
- **⏳ WCD-02 Literary Space & Relationship Deepening**：暂停大规模新增作者，优先补城市、地区、文学发生地、虚构空间及 author/work → place、movement、event、theme 等有证据关系；虚构空间继续禁止现实坐标。状态：`⏳ READY`，尚未开始。
