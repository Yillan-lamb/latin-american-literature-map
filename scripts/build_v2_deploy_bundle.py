...
DEVELOPMENT_PREVIEW_BANNER = "Web 0.4.1 Development Preview｜包含已批准 WCD-08 内容｜正式 Public Release 仍暂停"
...
def build(output: Path, data_path: Path, origin: str | None, development_preview: bool = False) -> dict[str, object]:
    ...
    routes = [""]
    static_pages = [
        ("authors/", "authors", None, "作家", "浏览已公开的拉丁美洲文学作家。", None),
        ("works/", "works", None, "作品", "浏览已公开的拉丁美洲文学作品。", None),
        ("anecdotes/", "anecdotes", None, "作家趣闻", "从人物故事进入作家的生活与写作。", None),
        ("search/", "search", None, "搜索", "搜索作家、作品、地点与文学主题。", None),
        ("timeline/", "timeline", None, "文学时间线", "沿时期、作家与作品理解拉丁美洲文学。", None),
        ("about/", "about", None, "关于项目", "了解项目、研究方法、空间区分与来源版权。", None),
    ]
