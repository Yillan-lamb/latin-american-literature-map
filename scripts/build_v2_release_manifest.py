...
RELEASE_FILES = (
    ...
    "site/assets/latin-america-countries.geojson", "site/assets/natural-earth-5.1.1-admin0-50m-latin-america.geojson", "site/README.md",
    ...
    "scripts/build_wcd09_basemap.py", "scripts/validate_wcd09_implementation.py", "requirements-wcd09.txt",
